...
export default class InlineObject extends React.Component
/*:: <Props, State>*/
{
  static defaultProps = {
    isSelected: false,
  ...
  _dropTarget =
    /*: ?{node: SlateNode, selection: SlateSelection}*/
    null
  _editorNode =
    /*: ?HTMLElement*/
    null
  ...
  handleDragEnd = (
    ...
    const {focusBlock, focusText} = editor.value // Create a new key for the "new" object
