...
export default class AnnotationButtons extends React.Component
/*:: <Props>*/
{
  ...
  getItems() {
    ...
    return blockContentFeatures.annotations.map((
      ...
      return {...annotation, active: editor.query('hasAnnotation', annotation.value), disabled}
    })
  }
